...
describe('Checking #DialogManager.replaceTags', function () {
  it('Hello {TAG}! === Hello world!', function () {
    assert.equal(DialogManager.replaceTags('Hello {TAG}!', { TAG: 'world' }), 'Hello world!')
  })
  it('{TAG} {TAG}! === world world!', function () {
    assert.equal(DialogManager.replaceTags('{TAG} {TAG}!', { TAG: 'world' }), 'world world!')
  })
  it('{Hello} {TAG}! === {Hello} world!', function () {
    assert.equal(DialogManager.replaceTags('{Hello} {TAG}!', { TAG: 'world' }), '{Hello} world!')
  })
  it('{Hi} {TAG}! === Hello world!', function () {
    assert.equal(DialogManager.replaceTags('{Hi} {TAG}!', { Hi: 'Hello', TAG: 'world' }), 'Hello world!')
  })
  it('{{} }{ {Ta } {Tag} === {{} }{ {Ta } Hello!', function () {
    assert.equal(DialogManager.replaceTags('{{} }{ {Ta } {Tag}', { Ta: 'Error', Tag: 'Hello!' }), '{{} }{ {Ta } Hello!')
  })
})
